...
CREATE TABLE IF NOT EXISTS `campaign_department_content_item_versions` (
    ...
    CONSTRAINT fk_content_item_versions_content FOREIGN KEY (content_id) REFERENCES `campaign_department_content_items`(id) ON DELETE CASCADE,
    CONSTRAINT fk_content_item_versions_user FOREIGN KEY (changed_by) REFERENCES `campaign_department_users`(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS `campaign_department_campaign_content_items` (
    ...
    CONSTRAINT fk_campaign_content_items_campaign FOREIGN KEY (campaign_id) REFERENCES `campaign_department_campaigns`(id) ON DELETE CASCADE,
    CONSTRAINT fk_campaign_content_items_content FOREIGN KEY (content_id) REFERENCES `campaign_department_content_items`(id) ON DELETE CASCADE,
    CONSTRAINT fk_campaign_content_items_user FOREIGN KEY (attached_by) REFERENCES `campaign_department_users`(id) ON DELETE SET NULL,
