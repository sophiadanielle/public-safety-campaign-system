...
INSERT IGNORE INTO users (id, role_id, barangay_id, name, email, password_hash, is_active) VALUES
...
INSERT IGNORE INTO audience_segments (id, name, geographic_scope, sector_type, risk_level, segmentation_basis, criteria) VALUES
...
INSERT IGNORE INTO partners (id, name, organization_type, contact_person, contact_email, contact_phone, contact_details) VALUES
...
INSERT IGNORE INTO campaigns (id, title, description, category, geographic_scope, status, start_date, end_date, owner_id, objectives, location, assigned_staff, barangay_target_zones, budget, staff_count, materials_json) VALUES
...
INSERT IGNORE INTO campaign_audience (campaign_id, segment_id) VALUES
...
INSERT IGNORE INTO events (id, campaign_id, name, event_type, description, event_date, event_time, location, venue, facilitators, attendance_count, status) VALUES
...
INSERT IGNORE INTO content_items (id, campaign_id, title, body, content_type, hazard_category, intended_audience, source, approval_status, file_path, created_by) VALUES
...
INSERT IGNORE INTO surveys (id, campaign_id, title, description) VALUES
...
INSERT IGNORE INTO survey_questions (id, survey_id, question_text, question_type, options_json) VALUES
...
INSERT IGNORE INTO feedback (feedback_id, survey_id, rating, comment, submitted_at) VALUES
...
INSERT IGNORE INTO partner_engagements (id, partner_id, campaign_id, engagement_type, notes) VALUES
