...
<body>
    ...
    <script>
        ...
        async function handleLogin(event) {
            ...
            try {
                const response = await fetch(basePath + '/api/auth_otp.php?action=login', {
                    method: 'POST',
        ...
        async function verifyOtp() {
            ...
            try {
                const response = await fetch(basePath + '/api/auth_otp.php?action=verify-otp', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        async function resendOtp() {
            ...
            try {
                const response = await fetch(basePath + '/api/auth_otp.php?action=resend-otp', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
